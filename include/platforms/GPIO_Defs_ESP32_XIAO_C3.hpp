#pragma once
/*
* GPIO_Defs_ESP32_XIAO_C3.hpp - Output Management class
*
...
#define DEFAULT_RMT_3_GPIO     gpio_num_t::GPIO_NUM_6
#define DEFAULT_RMT_4_GPIO     gpio_num_t::GPIO_NUM_7
#define DEFAULT_RMT_5_GPIO     gpio_num_t::GPIO_NUM_20


// File Manager
#define SUPPORT_SD
#define SD_CARD_MISO_PIN        gpio_num_t::GPIO_NUM_9
#define SD_CARD_MOSI_PIN        gpio_num_t::GPIO_NUM_10
#define SD_CARD_CLK_PIN         gpio_num_t::GPIO_NUM_8
